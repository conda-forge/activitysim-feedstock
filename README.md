...
Once the `conda-forge` channel has been enabled, `activitysim` can be installed with:

```
conda install activitysim
```

It is possible to list all of the versions of `activitysim` available on your platform with:
